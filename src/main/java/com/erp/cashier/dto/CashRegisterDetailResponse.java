...
/**
 * Detailed cash register response payload.
 *
...
public class CashRegisterDetailResponse {
    ...
    private List<CashRegisterSessionDetailResponse> sessions;

    /**
     * Default constructor for JSON serialization.
     */
    public CashRegisterDetailResponse() {
    }

    /**
     * Creates a detailed cash register response.
     *
     ...
     * @param sessions detailed session list
     */
    public CashRegisterDetailResponse(
            String id,
            String town,
            ...
            List<CashRegisterSessionDetailResponse> sessions
    ) {
        this.id = id;
        this.town = town;
